            ...
            <section className="row" id="about-container">
                ...
                <div className="col-md-6" id="about-txt-container">
                    ...
                    <div className="d-flex align-items-center justify-content-center mt-3 ms-5 mb-5">
                        <a className="btn btn-dark border-warning text-warning fw-bold d-flex align-items-center" href="https://drive.google.com/file/d/1OO2yEe7YSrt01t7Fg80Fu_P6nf-VMGmW/view" target="_black">Resume &nbsp;<span class="material-icons p-0">
                            download
                        </span></a>
                    </div>
                </div>
